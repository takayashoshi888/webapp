            ...
            <form id="create-app-form" class="space-y-4">
                <div>
                    ...
                    <input 
                        ...
                        required 
                        placeholder="输入应用名称" 
                        class="form-input w-full px-4 py-3 text-sm"
                    >
                </div>

                <div>
                    <label for="app-description" class="block text-sm font-medium text-gray-300 mb-2">
                        应用描述
                    </label>
                    <textarea 
                        id="app-description" 
                ...
                <div>
                    <label for="app-icon" class="block text-sm font-medium text-gray-300 mb-2">
                        应用图标
                    </label>
                    <select id="app-icon" name="icon" class="form-input w-full px-4 py-3 text-sm">
                ...
                <div>
                    <label for="app-framework" class="block text-sm font-medium text-gray-300 mb-2">
                        开发框架 *
                    </label>
                    <select id="app-framework" name="framework" required class="form-input w-full px-4 py-3 text-sm">
                ...
                <div>
                    <label for="app-platform" class="block text-sm font-medium text-gray-300 mb-2">
                        部署平台 *
                    </label>
                    <select id="app-platform" name="platform" required class="form-input w-full px-4 py-3 text-sm">
                ...
                <div>
                    <label for="app-database" class="block text-sm font-medium text-gray-300 mb-2">
                        数据库类型 *
                    </label>
                    <select id="app-database" name="database" required class="form-input w-full px-4 py-3 text-sm">
                ...
                <div>
                    <label for="app-domain" class="block text-sm font-medium text-gray-300 mb-2">
                        域名
                    </label>
                    <input 
                        type="text" 
                ...
                <div class="modal-actions flex space-x-3 pt-4">
                    ...
                    <button type="button" class="btn-secondary flex-1 py-3" onclick="modalManager.closeModal(modalManager.activeModal)">
                        取消
                    </button>
                </div>
            </form>
